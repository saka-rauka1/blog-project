...
@app.route('/')
def get_all_posts():
    return render_template("index.html", all_posts=get_blog_posts())
...
def register():
    ...
    if form.validate_on_submit():
        ...
        if db.session.query(User.id).filter_by(email=form.email.data).scalar() is not None:
        ...
        # For testing the password is 123456
